...
<div class="register-account ptb-50 ptb-sm-60">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form  id="user-form" class="form-register" action="{{route('user.update')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <fieldset>
                        <legend>@lang('lang.user_info_detail')</legend>
                        <div class="form-group row">
                            <label class="control-label col-md-2 text-md-left" for="f-name">
                                <span class="require">*</span>@lang('lang.name')
                            </label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-2 text-md-left" for="email">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-2 text-md-left" for="phone">
                                <span class="require"></span>@lang('lang.phone')
                            </label>
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="phone" placeholder="@lang('lang.phone')..." value="{{$user->phone}}">
                            </div>
                        </div>
                    
                        <div class="form-group row">
                            <label class="control-label col-md-2 text-md-left" for="status">
                                <span class="require"></span>@lang('lang.status')
                            </label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-2 text-md-left" for="address">
                                <span class="require"></span>@lang('lang.address')
                            </label>
                            <div class="col-md-10">
                    ...
                    <fieldset class="newsletter-input">
                        ...
                        <div class="form-group d-md-flex align-items-md-center">
                            <label class="control-label col-md-2 text-md-right" for="number">
                                <span class="require"></span>@lang('lang.avatar')
                            </label>
                            <div class="col-md-10">
