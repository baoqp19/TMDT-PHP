...
<div class="card-body">
    ...
    <form action="{{ asset('product.get-product-crawl') }}" method="POST">
        @csrf
        <div class="form-row text-center">
            <div class="col-md-12 mb-3 mt-2">
                <label for="validationTooltip01">Chọn thương hiệu</label>
                <select class="mb-2 form-control w-50 select-brand" style="margin: 0 auto;" name="productBrand" required>
                    <option value="" disabled selected>Chọn thương hiệu</option> <!-- Option mặc định -->
